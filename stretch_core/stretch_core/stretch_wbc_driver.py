...
class StretchWBCDriver(Node):

    def __init__(self):
        super().__init__('stretch_wbc_driver')
    ...
    def set_mobile_base_velocity_callback(self, base_msg):
        ...
        self.last_base_twist_time = self.get_clock().now()
        self.robot_mode_rwlock.release_read()
    ...
    def command_mobile_base_velocity_and_publish_state(self):
        ...
        if self.robot_mode == 'navigation':
            ...
            if time_since_last_base_cmd < self.timeout:
                ...
                self.robot.base.set_velocity(self.base_linear_velocity_mps, self.base_angular_velocity_radps)
    ...
    def ros_setup(self):
        ...
        self.last_arm_twist_time = time_now
        self.last_wrist_twist_time = time_now
